...
- Jenkins: `http://13.60.221.249:8080/`
- SonarQube: `http://56.228.42.133:9000/`
...
1. Create Webhook
    ...
    - Name: `Sonar-webhook`
    - URL: `http://13.60.221.249:8080/sonarqube-webhook/`
2. Create a Project
...
### 2. Add Credentials
  ...
  - Add new credential:
      - Kind: `Secret Text`
      - Secret: sqp_b9d4xxxxxxxxxxxxxxxxxxx
      - ID: `sonar-token`
### 3. Configure SonarQube Server
  ...
  - Add new SonarQube:
      - Name: Sonar-env
      - Server URL: `http://56.228.42.133:9000/`
